    ...
    <body>
        <div id="whole_game">
            ...
            <div id="game_board" onclick="clickGameBoard(event, this);">
                ...
                <div class="gridblock" data-positionId="4" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="5" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="6" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="7" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="8" data-groundType="water" onclick="clickWater(event, this);"></div>
                ...
                <div class="gridblock" data-positionId="9" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="10" data-groundType="water" onclick="clickWater(event, this);"></div>
                ...
                <div class="gridblock" data-positionId="11" data-groundType="water" onclick="clickWater(event, this);"></div>
                ...
                <div class="gridblock" data-positionId="12" data-groundType="water" onclick="clickWater(event, this);"></div>
                ...
                <div class="gridblock" data-positionId="13" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="14" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="15" data-groundType="water" onclick="clickWater(event, this);"></div>
                ...
                <div class="gridblock" data-positionId="22" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="23" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="24" data-groundType="water" onclick="clickWater(event, this);"></div>
                ...
                <div class="gridblock" data-positionId="25" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="26" data-groundType="water" onclick="clickWater(event, this);"></div>
                ...
                <div class="gridblock" data-positionId="27" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock">
<!--                    TODO: Deal with this exception later (special_island5)-->
                </div>
                <div class="gridblock" data-positionId="28" data-groundType="water" onclick="clickWater(event, this);"></div>
                ...
                <div class="gridblock" data-positionId="29" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="30" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="31" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="32" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="33" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="34" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="35" data-groundType="water" onclick="clickWater(event, this);"></div>
                ...
                <div class="gridblock" data-positionId="36" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="37" data-groundType="water" onclick="clickWater(event, this);"></div>
                ...
                <div class="gridblock" data-positionId="38" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="39" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="40" data-groundType="water" onclick="clickWater(event, this);"></div>
                ...
                <div class="gridblock" data-positionId="41" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="42" data-groundType="water" onclick="clickWater(event, this);"></div>
                ...
                <div class="gridblock" data-positionId="43" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="44" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="45" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="46" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="47" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="48" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="49" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="50" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="51" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="52" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="53" data-groundType="water" onclick="clickWater(event, this);"></div>
                <div class="gridblock" data-positionId="54" data-groundType="water" onclick="clickWater(event, this);"></div>
            </div>
        </div>
    </body>
</html>