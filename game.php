    ...
    <body onload="bodyLoader();">
        <div id="whole_game">
            ...
            <div id="game_board" onclick="gameboardClick(event, this);">
                ...
                <div class="gridblock" id="special_island5" data-islandPopped="false" ondragleave="islandDragleave(event, this);" ondragenter="islandDragenter(event, this);" onclick="islandClick(event, tphis);">
